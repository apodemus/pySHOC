...
def GaussUni(x, mu, sigma, l):
    """
    Joint pdf of combining Amplifier readout noise ~ Normal(\sigma, \mu) and
...
def PoissonGauss(x, delta, mu, sigma, N=300):
    """
    Joint pdf of CCD pixel dark current Poiss(\delta) and Amplifier readout noise N(\sigma, \mu).
...
#     """
#     Joint pdf of CCD pixel dark current (\delta) and amplifier bias voltage (b).
