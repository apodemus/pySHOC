    ...
    config_listener = {
        ...
        'handlers': {
            ...
            'file': {  # log *ALL* messages to *.log file
                ...
                'filename': str(path / 'main.log'),
                'mode': 'w',
                'formatter': 'detailed',
            },
            'errors': {  # log ERROR messages to *.errors.log file
                'class': 'logging.FileHandler',
                'filename': str(path / 'errors.log'),
                'mode': 'w',
                'level': 'ERROR',
                'formatter': 'detailed',
            },
...
#     config_main, config_listener, config_worker = config(path, logQ)
